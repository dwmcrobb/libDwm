...
for a given category of sources/sinks.
...
\texttt{read} and \texttt{write} of directly supported types is done
with regular function overloads.

\subsection{Function templates for STL container and other standard class templates}
Overloaded function templates are used to read and write types instantiated
via standard class templates, where the parameter types of the standard
...
and write types that meet the concept requirements.
