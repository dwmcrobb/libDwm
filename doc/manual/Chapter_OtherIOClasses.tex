\chapter{Other I/O classes, functions and function templates}

\section{\texttt{Dwm::SizedLength}}
\texttt{Dwm::SizedLength} represents a \texttt{uint64\_t} value, but
...
\texttt{Dwm::SizedLength} may be useful if the space/time tradeoff is
desired.

See \hyperref[encoding:DwmSizedLength]{\texttt{Dwm::SizedLength} on-the-wire
